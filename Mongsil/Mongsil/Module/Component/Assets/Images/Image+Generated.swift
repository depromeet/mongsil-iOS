...
extension R {
  public enum CustomImage {
    ...
    public static let FirstLoginImage = ImageAsset(name: "FirstLoginImage")
    public static let SecondLoginImage = ImageAsset(name: "SecondLoginImage")
    public static let ThirdLoginImage = ImageAsset(name: "ThirdLoginImage")
