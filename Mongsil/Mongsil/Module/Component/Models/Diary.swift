...
public struct Diary: Codable, Equatable, Hashable {
  ...
  public enum CodingKeys: String, CodingKey {
    case id, title, description, images, keywords, categories
...
extension Diary {
  public enum Stub {
    ...
    public static let diary1 = Diary(
      ...
      categories: [Category.Stub.category1, Category.Stub.category2]
    )
    public static let diary2 = Diary(
      ...
      date: convertDateToString(Date()),
      categories: [Category.Stub.category2]
    )
    public static let diary3 = Diary(
      ...
      date: convertDateToString(Date()),
      categories: [Category.Stub.category3]
    )
    public static let diary4 = Diary(
      ...
      date: convertDateToString(Date()),
      categories: [Category.Stub.category4]
    )
